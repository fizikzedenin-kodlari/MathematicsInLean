...
#check Group₂.mul
----------------------------------------------
def mySquare {α : Type*} [Group₂ α] (x : α) : α :=
  Group₂.mul x x
----------------------------------------------
#check mySquare
----------------------------------------------
...
#check (default : Point)
----------------------------------------------
example : ([] : List Point).head! = default :=
  rfl
----------------------------------------------
...
#check f * 1 * g⁻¹
----------------------------------------------
theorem foo : f * 1 * g⁻¹ = g.symm.trans ((Equiv.refl α).trans f) :=
  rfl
----------------------------------------------
end
----------------------------------------------
...
----------------------------------------------
instance [AddGroup₂ α] : Add α where
  add := AddGroup₂.add
----------------------------------------------
instance [AddGroup₂ α] : Zero α where
  zero := AddGroup₂.zero
----------------------------------------------
instance [AddGroup₂ α] : Neg α where
  neg := AddGroup₂.neg
----------------------------------------------