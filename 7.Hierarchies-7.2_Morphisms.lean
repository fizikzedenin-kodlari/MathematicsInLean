...
--7.Hierarchies
--7.2 Morphisms
def isMonoidHom₁ {G H} [Monoid G] [Monoid H] (f : G → H) : Prop :=
  f 1 = 1 ∧ ∀ g g', f (g * g') = f g * f g'
------------------------------------------------------
structure isMonoidHom₂ {G H} [Monoid G] [Monoid H] (f : G → H) : Prop where
  map_one : f 1 = 1
...
------------------------------------------------------
instance {G H} [Monoid G] [Monoid H] : CoeFun (MonoidHom₁ G H) (fun _ => G → H) where
  coe := MonoidHom₁.toFun
------------------------------------------------------
attribute [coe] MonoidHom₁.toFun
------------------------------------------------------
example {G H} [Monoid G] [Monoid H] (f : MonoidHom₁ G H) : f 1 = 1 := f.map_one
------------------------------------------------------
@[ext]
------------------------------------------------------
...
------------------------------------------------------
instance {G H} [AddMonoid G] [AddMonoid H] : CoeFun (AddMonoidHom₁ G H) (fun _ => G → H) where
...
@[reducible]
------------------------------------------------------
def badInst {M N F} [Monoid M] [Monoid N] [MonoidHomClass₁ F M N] : CoeFun F (fun _ ↦ M → N) where
...
class MonoidHomClass₂ (F : Type) (M N : outParam Type) [Monoid M] [Monoid N] where
  ...
  map_mul : ∀ f g g', toFun f (g * g') = toFun f g * toFun f g'
------------------------------------------------------
instance {M N F} [Monoid M] [Monoid N] [MonoidHomClass₂ F M N] : CoeFun F (fun _ ↦ M → N) where
  coe := MonoidHomClass₂.toFun
------------------------------------------------------
...
------------------------------------------------------
lemma map_inv_of_inv {M N F} [Monoid M] [Monoid N] [MonoidHomClass₂ F M N] (f : F) {m m' : M}
    (h : m * m' = 1) :
    f m * f m' = 1 := by
    rw [← MonoidHomClass₂.map_mul, h, MonoidHomClass₂.map_one]
------------------------------------------------------
example {M N} [Monoid M] [Monoid N] (f : MonoidHom₁ M N) {m m' : M} (h : m*m' = 1) : f m * f m' = 1 :=
  map_inv_of_inv f h
 ------------------------------------------------------
example {R S} [Ring R] [Ring S] (f : RingHom₁ R S) {r r' : R} (h : r*r' = 1) : f r * f r' = 1 :=
  map_inv_of_inv f h
------------------------------------------------------
